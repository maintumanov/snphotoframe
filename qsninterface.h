...
#define waitingTimeMemoryOperations 40
...
signals:
    ...
    // DBG
    void eventDBG(QSNContainer container, QObject *sender, bool directionOut);
    void eventDBGtext(QString text, QObject *sender);
...
public slots:
    ...
    void eventLog(quint8 warningLevel, QString text, QString fname, QString title, quint8 logmask);
